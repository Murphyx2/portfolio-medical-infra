...
|------|------|----------|------|----------|
| `127.0.0.1` | `5432` | `medicalconsultations` | `db_reviewer` | `bbppL1EQCsag45KI1srX1rYh` |
...
- Example: `docker exec -e PGPASSWORD=bbppL1EQCsag45KI1srX1rYh mc_db psql -U db_reviewer -d medicalconsultations -c "SELECT count(*) FROM patients_patient;"`
