...
- [x] Card 9 — `docker-compose.prod.yml` extends/merges the dev compose instead of near-duplicating it
- [x] Card 10 — per-repo CI (backend pytest+check, frontend vitest+`tsc -b && vite build`, infra compose config validation)
